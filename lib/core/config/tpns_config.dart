...
/// ```
///
/// iOS 需在 TPNS 控制台单独创建 iOS 应用，Bundle ID 为 `nova.dunes.dunes-app`
/// （iOS 不允许 Bundle ID 含下划线；Android 仍为 `nova.dunes.dunes_app`），
/// 上传 APNs 推送证书（p12 或 p8），并使用该 iOS 应用的 AccessID / AccessKey。
///
