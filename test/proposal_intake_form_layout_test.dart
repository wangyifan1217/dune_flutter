...
Finder _fieldOf(String label) => find.ancestor(
  of: find.text(label),
...
void main() {
        ...
        home: Scaffold(
          body: SizedBox(
            ...
            child: ProposalSelectField<int>(
              ...
              remoteOptions: true,
              options: const [
                ProposalSelectOption(value: 91, label: '年度框架协议'),
              ],
              onSelected: (_) {},
            ),
          ),
  ...
  testWidgets('market filler can edit market fields but not tech fill fields', (
    ...
    expect(
      find.text('请指定科技部负责人。技术字段由对方填写，你只做逐条复核。'),
      findsOneWidget,
    );
    expect(
  ...
  testWidgets('unsigned contract shows a file picker and purchase products add', (
    tester,
  ) async {
    tester.view.physicalSize = const Size(1440, 1800);
    tester.view.devicePixelRatio = 1;
